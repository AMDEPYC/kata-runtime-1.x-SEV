...
#define TASK_threadsp 2264 /* offsetof(struct task_struct, thread.sp) */
#define TASK_stack_canary 1008 /* offsetof(struct task_struct, stack_canary) */

#define TASK_addr_limit 2384 /* offsetof(struct task_struct, thread.addr_limit) */
